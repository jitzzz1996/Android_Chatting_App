...
public class ChatActivity extends AppCompatActivity
{
       ...
       mAdapter=new MessageAdapter(messagesList);
        ...
        mRootRef.child("Users").child(mChatUser).addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                Picasso.with(getApplicationContext()).load(image).placeholder(R.drawable.blankprofile).into(mProfileImage);
        ...
        //Code for adding Chat children in database
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (requestCode == GALLERY_PICK && resultCode == RESULT_OK)
        {
            ...
            StorageReference filepath = mImageStorage.child("MessageImages").child(push_id + ".jpg");
